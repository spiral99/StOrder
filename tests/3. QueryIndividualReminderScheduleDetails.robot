...
${QueryDetails_URL}  https://ms-standingorder-gateway.consumer-payments.apps.hqocp.safaricom.net

*** Test Cases ***
QueryIndividualReminderScheduleDetails Test Case   ${msisdn}    ${x-user-auth}    ${x-token-key}
...
Run Each Row As A Single Test Case
    ...
    Test Post QueryIndividualReminderScheduleDetails Request    ${msisdn}    ${x-user-auth}    ${x-token-key}
...
Test Post QueryIndividualReminderScheduleDetails Request
    ...
    Create Session    Query    ${QueryDetails_URL}

    ${response}  POST On Session    Query    /api/v1/queryIndividualReminderScheduleDetails   data=${body}    headers=${headers}
